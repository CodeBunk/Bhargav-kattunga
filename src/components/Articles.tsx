...
const Articles = () => {
  ...
  return (
    <div
      id="blog"
      className="flex flex-col items-center max-w-full mt-0 ml-0 bg-white px-5 py-10"
    >
      <div className="text-navblue text-center font-PromovaRegular lg:text-8xl self-center ml-0.5 mt-8 max-md:text-6xl text-4xl max-w-7xl">
        Recent articles
      </div>
      <div className="flex flex-col items-center max-w-[1280px] mb-10 max-md:max-w-full transition  ">
          ...
          {show
            ? List.map((article, index) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-black font-semibold opacity-60 tracking-normal text-base mt-3 max-h-48 overflow-hidden  overflow-ellipsis ">
        ...
        <div
          ...
          // className="text-white text-center text-sm self-center border hover:shadow-md  bg-navblue w-auto mt-20 p-5 rounded-[64px] border-solid border-zinc-600 max-md:pl-px max-md:pb-2.5 cursor-pointer hover:transform hover:scale-110 duration-500 ease-in-out "
          className="text-white text-center text-center bg-navblue p-4 mt-16 rounded-full border-solid cursor-pointer hover:transform hover:scale-110 duration-500 ease-in-out"
        >
          {!show ? (
            <div className="text-center mx-auto">Read the blogs</div>
          ) : (
            <div>Close the blogs</div>
          )}
        </div>
      </div>
    </div>

  ...
  return (
    <div className=" w-full lg:px-20 px-4 text-white md:pt-20 py-10 ">
      <div className="grid  gap-10 ">
        {/* {Data.map((props: any) => ( */}
        <a
          className={`flex flex-col gap-2 hover:scale-[101%] transition-all duration-300 cursor-pointer  `}
          target="_blank"
          href="https://medium.com/@bhargav.kattunga"
        >
          <div
            className={`max-h-40 py-10 aspect-video rounded-2xl border border-white transition-all duration-200  flex flex-col justify-center px-6    `}
          >
        ...
        >
          <div
            className={`max-h-40 py-10 aspect-video rounded-2xl border border-white transition-all duration-200  flex flex-col justify-center px-6  bg-black  `}
          >
            <div className="text-white font-times text-3xl font-normal ">
        ...
        <a
          className={`flex flex-col gap-2 md:col-span-2  row-span-1 col-span-1 hover:scale-[101%] transition-all duration-300 cursor-pointer  `}
          target="_blank"
